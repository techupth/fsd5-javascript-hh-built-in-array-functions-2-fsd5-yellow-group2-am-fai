...
// Start coding here
const newBills = bills.filter((filteredBill) => filteredBill.member !== null);
const totalMembers = newBills.filter((bill, index, self) => {
  return self.findIndex((b) => b.member.name === bill.member.name) === index;
});
